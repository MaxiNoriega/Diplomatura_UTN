    ...
    return (
        ...
        <main className="holder">
            ...
            <div className="imageneshome">
                <div className="imagenhome1">
                    <img src="img/home/imagenhome1.jpg" alt="imagenhome1" width="270"
                        height="270">
                </div>
                <div className="imagenhome2">
                    <img src="img/home/imagenhome2.jpg" alt="imagenhome2" width="270" height="270">
                </div>
                <div className="imagenhome3">
                    <img src="img/home/imagenhome3.jpg" alt="imagenhome3" width="270" height="270">
                </div>
                <div className="imagenhome4">
                    <img src="img/home/imagenhome4.jpg" alt="imagenhome3" width="270" height="270">
                </div>
            </div>
